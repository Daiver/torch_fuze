...
from .utils import ordered_dicts_almost_equal
...
class TestUtils(unittest.TestCase):
    def test_ordered_dicts_almost_equal1(self):
        ...
        self.assertTrue(ordered_dicts_almost_equal(d1, d2))

    def test_ordered_dicts_almost_equal2(self):
        d1 = OrderedDict([('1', 2.0), ('5', 3)])
        d2 = OrderedDict([('1', 2.0)])
        self.assertFalse(ordered_dicts_almost_equal(d1, d2))
    ...
    def test_ordered_dicts_almost_equal4(self):
        ...
        self.assertTrue(ordered_dicts_almost_equal(d1, d2, epsilon=0.1))
